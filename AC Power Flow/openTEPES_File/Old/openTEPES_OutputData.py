...
if sum(oT_ID.pOperReserveUp[sc,p,n] for sc,p,n in mTEPES.sc*mTEPES.p*mTEPES.n):
...
if sum(oT_ID.pOperReserveDw[sc,p,n] for sc,p,n in mTEPES.sc*mTEPES.p*mTEPES.n):
...
if len(mTEPES.r):
    OutputResults = pd.Series(data=[(oT_ID.pMaxPower[r][sc,p,n]-mTEPES.vTotalOutput[sc,p,n,r]())*1e3 for sc,p,n,r in mTEPES.sc*mTEPES.p*mTEPES.n*mTEPES.r], index=pd.MultiIndex.from_tuples(list(mTEPES.sc*mTEPES.p*mTEPES.n*mTEPES.r)))
...
OutputResults = pd.Series(data=[mTEPES.vTotalOutput[sc,p,n,nr]()*oT_ID.pCO2EmissionRate[nr]*1e3      for sc,p,n,nr in mTEPES.sc*mTEPES.p*mTEPES.n*mTEPES.t], index=pd.MultiIndex.from_tuples(list(mTEPES.sc*mTEPES.p*mTEPES.n*mTEPES.t)))
...
if len(mTEPES.es):
    ...
    OutputResults = pd.Series(data=[mTEPES.vESSCharge   [sc,p,n,es]()*oT_ID.pDuration[n] for sc,p,n,es in mTEPES.sc*mTEPES.p*mTEPES.n*mTEPES.es], index=pd.MultiIndex.from_tuples(list(mTEPES.sc*mTEPES.p*mTEPES.n*mTEPES.es)))
...
OutputResults = pd.Series(data=[abs(mTEPES.vFlow[sc,p,n,ni,nf,cc]()/oT_ID.pLineNTC[ni,nf,cc]) for sc,p,n,ni,nf,cc in mTEPES.sc*mTEPES.p*mTEPES.n*mTEPES.la], index= pd.MultiIndex.from_tuples(list(mTEPES.sc*mTEPES.p*mTEPES.n*mTEPES.la)))
OutputResults.index.names = ['Scenario','Period','LoadLevel','InitialNode','FinalNode','Circuit']
...
OutputResults = pd.Series(data=[mTEPES.vENS[sc,p,n,nd]()*oT_ID.pDuration[n] for sc,p,n,nd in mTEPES.sc*mTEPES.p*mTEPES.n*mTEPES.nd], index=pd.MultiIndex.from_tuples(list(mTEPES.sc*mTEPES.p*mTEPES.n*mTEPES.nd)))
...
OutputResults = pd.Series(data=[mTEPES.dual[mTEPES.eBalance[sc,p,n,nd]]*1e3/oT_ID.pScenProb[sc]/oT_ID.pDuration[n] for sc,p,n,nd in mTEPES.sc*mTEPES.p*mTEPES.n*mTEPES.nd], index=pd.MultiIndex.from_tuples(list(mTEPES.sc*mTEPES.p*mTEPES.n*mTEPES.nd)))
